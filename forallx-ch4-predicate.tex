...
Ez rögzíti a struktúrát, amelyet kihagytak ennek az argumentumnak a SL fordításából, és ez egy érvényes argumentum a QL-ben.
...
A \ref{defdesc2}b mondat Franciaország jelenlegi királyáról állít valamit. Azt mondja, hogy nem birtokolja a kopaszság tulajdonságát. Mint a \ref{defdesc1}-es mondat, állítja a létezését és az egyediségét, csak ez tagadja a predikátum állítását. Ezt \define{szűk körű negációnak} nevezzük. A következőképpen fordíthatjuk: $\exists x\bigl[Fx \eand \enot\exists y(Fy \eand x\neq y) \eand \enot Bx\bigr]$. Mivel Franciaországnak jelenleg nincs királya, ezért ez a mondat hamis.
